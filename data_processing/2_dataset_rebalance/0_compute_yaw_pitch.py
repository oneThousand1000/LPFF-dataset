...
if __name__ == '__main__':
    ...
    np.save('./files/camera_yaws.npy',x_data)
    np.save('./files/camera_pitches.npy',y_data)
    ...
    plt.xlabel(r"$yaw$", fontsize=35)
    plt.ylabel(r"$pitch$", rotation=0, fontsize=35)
    ...
    # 显示所绘图形
    plt.savefig('./imgs/ffhq-lpff-v2.png', dpi=100, format='png',
                bbox_inches='tight')
    plt.savefig('./imgs/ffhq-lpff-v2.pdf', dpi=100, format='pdf',
                bbox_inches='tight')
    plt.show()
    ...
    plt.tight_layout(pad=0.4, w_pad=0.4, h_pad=0.4)
    # 显示所绘图形
    plt.savefig('./imgs/ffhq-v2.png', dpi=100, format='png',
                bbox_inches='tight')
    plt.savefig('./imgs/ffhq-v2.pdf', dpi=100, format='pdf',
                bbox_inches='tight')
    plt.show()
