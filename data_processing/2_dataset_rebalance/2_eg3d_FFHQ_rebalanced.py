...
color = {1: '#377EDB', 2: '#85A97E', 3: '#D4A9B8', 4: '#9E406B', 5: '#732B7E', 6: '#DB8039', 7: '#CA9BE4', 8: '#C8A242', 9: '#10095A', 10: '#CA9BE4', 11: '#7AA8DE', 12: '#7AA8DE', 13: '#B58A5D', 14: '#ED71D9', 15: '#05DE75', 16: '#053687', 17: '#0D5308', 18: '#10095A', 19: '#F5981D', 20: '#053687', 21: '#6BB4A1', 22: '#1EEFFA', 23: '#D3B435', 24: '#BB79E1', 25: '#055C32', 26: '#2B75E3', 27: '#53E03B', 28: '#FA4453', 29: '#194DA4', 30: '#C8A075', 31: '#CF4B23', 32: '#F748E8', 33: '#04E639', 34: '#343ECB', 35: '#A940A4', 36: '#C44C57', 37: '#6DBAB6', 38: '#1D55F7', 39: '#616FD8', 40: '#4C7C1F', 41: '#4C0A59', 42: '#42DF97', 43: '#62009A', 44: '#E91254', 45: '#AEE45F', 46: '#B708DC', 47: '#95F129', 48: '#D9578C', 49: '#B4763B', 50: '#FDD38F', 51: '#D3B14A', 52: '#020187', 53: '#8EDDA5', 54: '#1A9329', 55: '#F8D600', 56: '#393181', 57: '#656C7F', 58: '#2D1789', 59: '#6CDAA4', 60: '#D63E9C', 61: '#9CB8A1', 62: '#871B3B', 63: '#56AA6A'}
...
if __name__ == '__main__':
    ...
    with open('./FFHQ_num_replicas.json', 'r') as f:
    ...
    for i in range(139914):
        ...
        duplicate_num = duplicates[str(i)]
    ...
    with open(os.path.join(eg3d_dataset_dir,f'FFHQ_rebalanced.json'), "w", newline='\n') as f:
        f.write(data)
    ...
    # 显示所绘图形
    plt.savefig('./imgs/ffhq-rebal.png', dpi=100, format='png',
                bbox_inches='tight')
    plt.savefig('./imgs/ffhq-rebal.pdf', dpi=100, format='pdf',
                bbox_inches='tight')
    plt.show()
