...
class MyVisualizer:
    ...
    def display_current_results(self, visuals, total_iters, epoch, dataset='train', save_results=False, save_path = None,count=0, name=None,
            add_image=True):
        """Display current results on tensorboad; save current results to an HTML file.
            ...
            for i in range(image.shape[0]):
                ...
                if save_results:
                    if save_path is None:
                        ...
                        save_path = os.path.join(self.img_folder, 'epoch_%s_%06d' % (epoch, 0))
                    print('save debug rendering image to',save_path)
