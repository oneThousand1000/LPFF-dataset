...
def resize_n_crop_img(img, lm, t, s, target_size=224., mask=None):
    ...
    return img, lm, mask,lm_transformation
...
def align_img(img, lm, lm3D, mask=None, target_size=224., rescale_factor=102.):
    ...
    img_new, lm_new, mask_new,lm_transformation = resize_n_crop_img(img, lm, t, s, target_size=target_size, mask=mask)
    trans_params = np.array([w0, h0, s, t[0], t[1]])

    return trans_params, img_new, lm_new, mask_new,lm_transformation
